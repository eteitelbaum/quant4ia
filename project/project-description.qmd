...
- In our first final project workshop on `r advdate2(tues, 14)`, please come to class ready to discuss your research question and dataset (details below). This will be an opportunity for you to make sure you are on the right track with the question you have selected and the data you are working with.

- In the workshop we will also discuss some advanced formatting techniques and how to publish and share your project. <!-- TODO: publishing platform TBD (Posit Connect Cloud?) -->

- The project is **due on `r advdate2(sun, 15)`** by 11:59 p.m., however you are free to submit the project anytime before then.
