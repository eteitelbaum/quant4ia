...
**Primary Website**: https://quant4ia.rocks

This is the **generic / term-neutral** copy of the course, adapted each semester. The current instance is **Fall 2026** (Tuesday/Thursday, 1957 E Street Rm. 314).
...
```r
mon <- as_date("2026-08-24")  # Monday of the first week of classes; update for new semester
```
...
- The course website is published to quant4ia.rocks
- This is the generic/term-neutral repo (`quant4ia`), reused each semester by updating `helper.R`, the term string in `_quarto.yml`, the room in `course-syllabus.qmd`, and the break rows in `index.qmd`
