...
| **Location**: [1957 E Street, Rm. 314](https://maps.google.com/?q=1957+E+St+NW,+Washington,+DC+20052)
|
| **Meeting Times**: Tuesdays, 12:45–3:15 p.m.
|
| **Instructor**: Prof. Emmanuel Teitelbaum
| Email: [ejt\@gwu.edu](mailto:ejt@gwu.edu)
| Office Hours: [Mondays, 3-5 p.m.](https://calendly.com/emmanuel-teitelbaum/15min)
| 
| **Credit Hours**: 3.0.
...
This course exists so that *you* develop genuine skill in R and in the quantitative analysis of international affairs data. AI coding assistants — such as ChatGPT, Claude, Gemini, Copilot, and IDE-integrated tools like Cursor — are now a real part of data science practice, and you are welcome to use them. But *how* and *when* you use them determines whether you actually learn. There is an important distinction between using AI as a learning support and using it to replace learning entirely. If you simply paste an assignment into an AI and copy the output, you will pass the assignment but miss the course, and you will struggle in later courses, in job interviews, and on the job itself, where these skills will be expected of you.

Because different assessments serve different purposes, this course sets different rules for each one. The progression is deliberate: labs get your own hands on the code, the homework assignments stretch you toward independent problem-solving, and the final project is your chance to work the way a practitioner increasingly does.

### The four principles

Follow these principles whenever you use AI tools in this course:

-   **Try first**: Before turning to an AI tool, consult the course materials — the modules, slides, and readings. Labs are AI-free, so work through the guided hints instead. For homework, it is appropriate to consult AI once you are genuinely stuck.
...
-   **Labs — no AI.** Labs are short, mostly fill-in-the-blank exercises, and their whole purpose is to get *your* fingers on the code and familiarize you with the syntax. An AI tool can fill in those blanks in seconds, which is exactly why you should not let it: there is nothing left to learn once you do. Work through them on your own, using the course materials and the hints at the bottom of each lab, and come see me or ask a classmate if you are stuck.

-   **Homework — consultation and debugging.** The homework assignments are more open-ended and challenging. In addition to conceptual questions, you may use AI to help **debug** code that isn't running the way you expect. You should still write your own code and be able to explain everything you submit; do not simply paste the assignment in and copy the output. Note whether and how you used AI in your submission.

-   **Final project — any AI-assisted workflow.** For the final project, a full, modern AI-assisted workflow is encouraged — AI is a real tool that data scientists use every day. The design, data choices, analysis, and interpretation must still be your own, and you should be able to explain and defend everything in your project.
