...
|
| **Meeting Times**: Tuesdays & Thursdays, 12:45–3:15 p.m.
|
...
AI tools (such as ChatGPT, Claude, Gemini, Copilot, and others) can be genuinely useful companions for learning to code and analyze data. Think of them as a tutor available around the clock, one you can ask to explain a concept, clarify an error message, or walk through how a function works. At the same time, there is an important distinction between using AI to learn and using AI instead of learning. The goal of this course is for you to develop real skills in R, data analysis, and statistical reasoning. If you simply paste an assignment into an AI and copy the output, you will pass the assignment but miss the course, and you will struggle in future courses, in job interviews, and on the job itself, where these skills will be expected of you.

Because different assessments serve different purposes, this course sets different rules for how much you can lean on AI for each one. The progression is deliberate: labs build your fundamentals, homeworks stretch you toward independent problem-solving, and the final project is your chance to work the way a practitioner increasingly does.

#### What is allowed on each assessment

-   **Labs — consultation only.** Labs are guided, fill-in-the-blank exercises meant to build your core skills. You may use AI to *consult*: to explain a concept, clarify an error message, or describe what a function does. You should not have AI write or fix your lab code for you. Work through the hints at the bottom of each lab first.

-   **Homework — consultation and debugging.** Homeworks are more open-ended and challenging. In addition to consultation, you may use AI to help *debug* code that isn't running the way you expect. You should still write your own code and be able to explain everything you submit; do not simply paste the assignment in and copy the output.

-   **Final project — any AI-assisted workflow.** For the final project you may use a fully AI-centered workflow, including having AI help generate and structure your code. This mirrors real-world data analysis practice. You remain fully responsible for the correctness, quality, and integrity of what you submit, and you should understand your own project well enough to present and defend it.

#### General principles

**Try first, then consult.** Whatever the assessment, your first move should be to consult the course materials — the modules, slides, and readings — before turning to AI.
...
**Acknowledge your use.** In your submission statement, note whether and how you used AI tools on that assignment.
